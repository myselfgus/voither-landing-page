    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] transition-all duration-500 py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className={`
          ...
          ${isScrolled
            ? 'bg-white/70 backdrop-blur-2xl shadow-xl border-white/40 scale-[0.98]'
        ...
        `}>
          ...
          <button
            ...
            className="md:hidden p-3 rounded-xl bg-white/40 backdrop-blur-md shadow-neu-soft border border-white/40 active:scale-95 transition-transform"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="absolute top-32 left-4 right-4 bg-white/90 backdrop-blur-3xl rounded-[3.5rem] p-10 shadow-2xl border border-white/40 z-[101] md:hidden"
          >
